...
void slv6_G_ADC_M1_Imm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g17.S;
  const uint8_t d = instr->args.g17.d;
  const uint8_t n = instr->args.g17.n;
  const uint8_t rotate_imm = instr->args.g17.rotate_imm;
  const SLv6_Condition cond = instr->args.g17.cond;
  const uint32_t immed_rotated = instr->args.g17.immed_rotated;
...
void slv6_G_ADC_M1_LSLImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
  const uint8_t shift_imm = instr->args.g18.shift_imm;
  const SLv6_Condition cond = instr->args.g18.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rn = reg(proc,n);
...
void slv6_G_ADC_M1_LSLReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
  const uint8_t s = instr->args.g19.s;
  const SLv6_Condition cond = instr->args.g19.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
...
void slv6_G_ADC_M1_LSRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_ADC_M1_LSRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_ADC_M1_ASRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_ADC_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_ADC_M1_RRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_ADC_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_ADC_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g20.S;
  const uint8_t d = instr->args.g20.d;
  const uint8_t m = instr->args.g20.m;
  const uint8_t n = instr->args.g20.n;
  const SLv6_Condition cond = instr->args.g20.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rn = reg(proc,n);
  const uint32_t old_Rm = reg(proc,m);
  bool shifter_carry_out;
...
void slv6_G_ADD_M1_LSLReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_ADD_M1_LSRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_ADD_M1_ASRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_ADD_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_ADD_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_ADD_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g20.S;
  const uint8_t d = instr->args.g20.d;
  const uint8_t m = instr->args.g20.m;
  const uint8_t n = instr->args.g20.n;
...
void slv6_G_AND_M1_LSLImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_AND_M1_LSLReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_AND_M1_LSRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_AND_M1_LSRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_AND_M1_ASRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_AND_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_AND_M1_RRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_AND_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_AND_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g20.S;
  const uint8_t d = instr->args.g20.d;
  const uint8_t m = instr->args.g20.m;
  const uint8_t n = instr->args.g20.n;
...
void slv6_G_BIC_M1_Reg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g20.S;
  const uint8_t d = instr->args.g20.d;
  const uint8_t m = instr->args.g20.m;
  const uint8_t n = instr->args.g20.n;
...
void slv6_G_BIC_M1_LSLImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_BIC_M1_LSLReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_BIC_M1_LSRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_BIC_M1_LSRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_BIC_M1_ASRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_BIC_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_BIC_M1_RRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_BIC_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_BIC_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g20.S;
  const uint8_t d = instr->args.g20.d;
  const uint8_t m = instr->args.g20.m;
  const uint8_t n = instr->args.g20.n;
...
/* A4.1.7
 * BKPT */
void slv6_G_BKPT(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
/* A4.1.8
 * BLX (1) */
void slv6_G_BLX1(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint32_t pc_offset_h = instr->args.g21.pc_offset_h;
...
/* A4.1.9
 * BLX (2) */
void slv6_G_BLX2(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
/* A4.1.11
 * BXJ */
void slv6_G_BXJ(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g12.m;
  const SLv6_Condition cond = instr->args.g12.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rm = reg(proc,m);
...
/* A4.1.12
 * CDP */
void slv6_G_CDP(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t cp_num = instr->args.g22.cp_num;
  const SLv6_Condition cond = instr->args.g22.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
...
/* A4.1.13
 * CLZ */
void slv6_G_CLZ(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
void slv6_G_CMN_M1_LSLImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rn = reg(proc,n);
  const uint32_t old_Rm = reg(proc,m);
  uint32_t alu_out;
...
void slv6_G_CMN_M1_LSLReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rs = reg(proc,s);
  const uint32_t old_Rn = reg(proc,n);
  const uint32_t old_Rm = reg(proc,m);
...
void slv6_G_CMN_M1_LSRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
...
void slv6_G_CMN_M1_LSRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
...
void slv6_G_CMN_M1_ASRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
...
void slv6_G_CMN_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
...
void slv6_G_CMN_M1_RRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
...
void slv6_G_CMN_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
...
void slv6_G_CMN_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
void slv6_G_CMP_M1_LSLImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
...
void slv6_G_CMP_M1_LSLReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
...
void slv6_G_CMP_M1_LSRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
...
void slv6_G_CMP_M1_LSRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
...
void slv6_G_CMP_M1_ASRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
...
void slv6_G_CMP_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
...
void slv6_G_CMP_M1_RRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
...
void slv6_G_CMP_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
...
void slv6_G_CMP_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g4.m;
  const uint8_t n = instr->args.g4.n;
  const SLv6_Condition cond = instr->args.g4.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
...
/* A4.1.16
 * CPS */
void slv6_G_CPS(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool A = instr->args.g25.A;
  const bool F = instr->args.g25.F;
  const bool I = instr->args.g25.I;
  const uint8_t imod = instr->args.g25.imod;
  const bool mmod = instr->args.g25.mmod;
  const SLv6_Mode mode = instr->args.g25.mode;
...
void slv6_G_EOR_M1_LSLReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_EOR_M1_LSRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_EOR_M1_ASRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_EOR_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_EOR_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_EOR_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g20.S;
  const uint8_t d = instr->args.g20.d;
  const uint8_t m = instr->args.g20.m;
  const uint8_t n = instr->args.g20.n;
...
void slv6_G_LDC_M5_ImmOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  exec_undefined_instruction(proc, NULL);
}

/* A4.1.19--A5.5.3
 * LDC -- Load and Store Coprocessor - Immediate pre indexed */
void slv6_G_LDC_M5_Imm_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  exec_undefined_instruction(proc, NULL);
}

/* A4.1.19--A5.5.4
 * LDC -- Load and Store Coprocessor - Immediate post indexed */
void slv6_G_LDC_M5_Imm_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  exec_undefined_instruction(proc, NULL);
}

/* A4.1.19--A5.5.5
 * LDC -- Load and Store Coprocessor - Unindexed */
void slv6_G_LDC_M5_U(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  exec_undefined_instruction(proc, NULL);
}

/* A4.1.20--A5.4.4
 * LDM (1) -- Load and Store Multiple - Decrement after */
void slv6_G_LDM1_M4_DA(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool W = instr->args.g26.W;
  const uint8_t n = instr->args.g26.n;
  const uint8_t nb_reg_x4 = instr->args.g26.nb_reg_x4;
  const SLv6_Condition cond = instr->args.g26.cond;
  const uint32_t register_list = instr->args.g26.register_list;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rn = reg(proc,n);
  uint32_t address;
...
void slv6_G_LDM1_M4_DB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool W = instr->args.g26.W;
  const uint8_t n = instr->args.g26.n;
  const uint8_t nb_reg_x4 = instr->args.g26.nb_reg_x4;
  const SLv6_Condition cond = instr->args.g26.cond;
...
void slv6_G_LDM2_M4_IA(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
void slv6_G_LDM2_M4_IB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t n = instr->args.g9.n;
  const uint8_t nb_reg_x4 = instr->args.g9.nb_reg_x4;
  const SLv6_Condition cond = instr->args.g9.cond;
  const uint32_t register_list = instr->args.g9.register_list;
...
void slv6_G_LDM2_M4_DA(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t n = instr->args.g9.n;
  const uint8_t nb_reg_x4 = instr->args.g9.nb_reg_x4;
  const SLv6_Condition cond = instr->args.g9.cond;
  const uint32_t register_list = instr->args.g9.register_list;
...
void slv6_G_LDM2_M4_DB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t n = instr->args.g9.n;
  const uint8_t nb_reg_x4 = instr->args.g9.nb_reg_x4;
  const SLv6_Condition cond = instr->args.g9.cond;
  const uint32_t register_list = instr->args.g9.register_list;
...
void slv6_G_LDM3_M4_IA(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool W = instr->args.g26.W;
  const uint8_t n = instr->args.g26.n;
  const uint8_t nb_reg_x4 = instr->args.g26.nb_reg_x4;
  const SLv6_Condition cond = instr->args.g26.cond;
...
void slv6_G_LDM3_M4_IB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool W = instr->args.g26.W;
  const uint8_t n = instr->args.g26.n;
  const uint8_t nb_reg_x4 = instr->args.g26.nb_reg_x4;
  const SLv6_Condition cond = instr->args.g26.cond;
...
void slv6_G_LDM3_M4_DA(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool W = instr->args.g26.W;
  const uint8_t n = instr->args.g26.n;
  const uint8_t nb_reg_x4 = instr->args.g26.nb_reg_x4;
  const SLv6_Condition cond = instr->args.g26.cond;
...
void slv6_G_LDM3_M4_DB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool W = instr->args.g26.W;
  const uint8_t n = instr->args.g26.n;
  const uint8_t nb_reg_x4 = instr->args.g26.nb_reg_x4;
  const SLv6_Condition cond = instr->args.g26.cond;
...
void slv6_G_LDR_M2_Reg_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
  const SLv6_Condition cond = instr->args.g27.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rn = reg(proc,n);
  const uint32_t old_Rm = reg(proc,m);
  uint32_t address;
...
void slv6_G_LDR_M2_ScReg_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g28.U;
  const uint8_t d = instr->args.g28.d;
  const uint8_t m = instr->args.g28.m;
  const uint8_t n = instr->args.g28.n;
  const uint8_t shift = instr->args.g28.shift;
  const uint8_t shift_imm = instr->args.g28.shift_imm;
  const SLv6_Condition cond = instr->args.g28.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rn = reg(proc,n);
  const uint32_t old_Rm = reg(proc,m);
  uint32_t address;
...
void slv6_G_LDR_M2_Reg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDR_M2_ScReg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g28.U;
  const uint8_t d = instr->args.g28.d;
  const uint8_t m = instr->args.g28.m;
  const uint8_t n = instr->args.g28.n;
...
void slv6_G_LDRB_M2_Imm_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
void slv6_G_LDRB_M2_Reg_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDRB_M2_ScReg_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g28.U;
  const uint8_t d = instr->args.g28.d;
  const uint8_t m = instr->args.g28.m;
  const uint8_t n = instr->args.g28.n;
...
void slv6_G_LDRB_M2_Imm_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g1.d;
  const uint8_t n = instr->args.g1.n;
  const SLv6_Condition cond = instr->args.g1.cond;
  const uint32_t signed_offset_12 = instr->args.g1.signed_offset_12;
...
void slv6_G_LDRB_M2_Reg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDRB_M2_ScReg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g28.U;
  const uint8_t d = instr->args.g28.d;
  const uint8_t m = instr->args.g28.m;
  const uint8_t n = instr->args.g28.n;
...
void slv6_G_LDRBT_M2_Imm_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g1.d;
  const uint8_t n = instr->args.g1.n;
  const SLv6_Condition cond = instr->args.g1.cond;
  const uint32_t signed_offset_12 = instr->args.g1.signed_offset_12;
...
void slv6_G_LDRBT_M2_Reg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDRBT_M2_ScReg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g28.U;
  const uint8_t d = instr->args.g28.d;
  const uint8_t m = instr->args.g28.m;
  const uint8_t n = instr->args.g28.n;
...
void slv6_G_LDRD_M3_ImmOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
  const SLv6_Condition cond = instr->args.g29.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rn = reg(proc,n);
  uint32_t address;
  uint8_t offset_8;
...
void slv6_G_LDRD_M3_RegOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDRD_M3_Imm_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_LDRD_M3_Reg_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDRD_M3_Imm_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_LDRD_M3_Reg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
/* A4.1.27
 * LDREX */
void slv6_G_LDREX(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g30.d;
  const uint8_t n = instr->args.g30.n;
  const SLv6_Condition cond = instr->args.g30.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rn = reg(proc,n);
...
void slv6_G_LDRH_M3_RegOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDRH_M3_Imm_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_LDRH_M3_Reg_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDRH_M3_Imm_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_LDRH_M3_Reg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDRSB_M3_ImmOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_LDRSB_M3_RegOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDRSB_M3_Imm_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_LDRSB_M3_Reg_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDRSB_M3_Imm_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_LDRSB_M3_Reg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDRSH_M3_ImmOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_LDRSH_M3_RegOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDRSH_M3_Imm_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_LDRSH_M3_Reg_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDRSH_M3_Imm_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_LDRSH_M3_Reg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDRT_M2_Imm_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g1.d;
  const uint8_t n = instr->args.g1.n;
  const SLv6_Condition cond = instr->args.g1.cond;
  const uint32_t signed_offset_12 = instr->args.g1.signed_offset_12;
...
void slv6_G_LDRT_M2_Reg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_LDRT_M2_ScReg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g28.U;
  const uint8_t d = instr->args.g28.d;
  const uint8_t m = instr->args.g28.m;
  const uint8_t n = instr->args.g28.n;
...
/* A4.1.32
 * MCR */
void slv6_G_MCR(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t CRm = instr->args.g31.CRm;
  const uint8_t CRn = instr->args.g31.CRn;
  const uint8_t cp_num = instr->args.g31.cp_num;
  const uint8_t d = instr->args.g31.d;
  const uint8_t opcode_1 = instr->args.g31.opcode_1;
  const uint8_t opcode_2 = instr->args.g31.opcode_2;
  const SLv6_Condition cond = instr->args.g31.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
...
/* A4.1.33
 * MCRR */
void slv6_G_MCRR(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t cp_num = instr->args.g32.cp_num;
  const uint8_t d = instr->args.g32.d;
  const uint8_t n = instr->args.g32.n;
  const SLv6_Condition cond = instr->args.g32.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rn = reg(proc,n);
...
/* A4.1.34
 * MLA */
void slv6_G_MLA(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_MOV_M1_Reg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g33.S;
  const uint8_t d = instr->args.g33.d;
  const uint8_t m = instr->args.g33.m;
  const SLv6_Condition cond = instr->args.g33.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rm = reg(proc,m);
  bool shifter_carry_out;
  uint32_t shifter_operand;
...
void slv6_G_MOV_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g34.S;
  const uint8_t d = instr->args.g34.d;
  const uint8_t m = instr->args.g34.m;
  const uint8_t s = instr->args.g34.s;
  const SLv6_Condition cond = instr->args.g34.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rs = reg(proc,s);
  const uint32_t old_Rm = reg(proc,m);
  bool shifter_carry_out;
...
void slv6_G_MOV_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g34.S;
  const uint8_t d = instr->args.g34.d;
  const uint8_t m = instr->args.g34.m;
  const uint8_t s = instr->args.g34.s;
...
void slv6_G_MOV_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g33.S;
  const uint8_t d = instr->args.g33.d;
  const uint8_t m = instr->args.g33.m;
  const SLv6_Condition cond = instr->args.g33.cond;
...
/* A4.1.36
 * MRC */
void slv6_G_MRC(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t CRm = instr->args.g31.CRm;
  const uint8_t CRn = instr->args.g31.CRn;
  const uint8_t cp_num = instr->args.g31.cp_num;
  const uint8_t d = instr->args.g31.d;
...
/* A4.1.37
 * MRRC */
void slv6_G_MRRC(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t cp_num = instr->args.g32.cp_num;
  const uint8_t d = instr->args.g32.d;
  const uint8_t n = instr->args.g32.n;
  const SLv6_Condition cond = instr->args.g32.cond;
...
/* A4.1.38
 * MRS */
void slv6_G_MRS(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool R = instr->args.g35.R;
  const uint8_t d = instr->args.g35.d;
  const SLv6_Condition cond = instr->args.g35.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  if ((R == 1))
...
/* A4.1.39
 * MSRimm */
void slv6_G_MSRimm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool R = instr->args.g36.R;
  const uint8_t field_mask = instr->args.g36.field_mask;
  const uint8_t rotate_imm = instr->args.g36.rotate_imm;
  const SLv6_Condition cond = instr->args.g36.cond;
  const uint32_t immed_rotated = instr->args.g36.immed_rotated;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  uint32_t byte_mask;
  uint32_t mask;
  uint32_t operand;
...
/* A4.1.39
 * MSRreg */
void slv6_G_MSRreg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool R = instr->args.g37.R;
  const uint8_t field_mask = instr->args.g37.field_mask;
  const uint8_t m = instr->args.g37.m;
  const SLv6_Condition cond = instr->args.g37.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rm = reg(proc,m);
  uint32_t byte_mask;
  uint32_t mask;
...
void slv6_G_MVN_M1_LSLImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g38.S;
  const uint8_t d = instr->args.g38.d;
  const uint8_t m = instr->args.g38.m;
  const uint8_t shift_imm = instr->args.g38.shift_imm;
  const SLv6_Condition cond = instr->args.g38.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rm = reg(proc,m);
  bool shifter_carry_out;
  uint32_t shifter_operand;
...
void slv6_G_MVN_M1_LSLReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g34.S;
  const uint8_t d = instr->args.g34.d;
  const uint8_t m = instr->args.g34.m;
  const uint8_t s = instr->args.g34.s;
...
void slv6_G_MVN_M1_LSRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g38.S;
  const uint8_t d = instr->args.g38.d;
  const uint8_t m = instr->args.g38.m;
  const uint8_t shift_imm = instr->args.g38.shift_imm;
...
void slv6_G_MVN_M1_LSRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g34.S;
  const uint8_t d = instr->args.g34.d;
  const uint8_t m = instr->args.g34.m;
  const uint8_t s = instr->args.g34.s;
...
void slv6_G_MVN_M1_ASRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g38.S;
  const uint8_t d = instr->args.g38.d;
  const uint8_t m = instr->args.g38.m;
  const uint8_t shift_imm = instr->args.g38.shift_imm;
...
void slv6_G_MVN_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g34.S;
  const uint8_t d = instr->args.g34.d;
  const uint8_t m = instr->args.g34.m;
  const uint8_t s = instr->args.g34.s;
...
void slv6_G_MVN_M1_RRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g38.S;
  const uint8_t d = instr->args.g38.d;
  const uint8_t m = instr->args.g38.m;
  const uint8_t shift_imm = instr->args.g38.shift_imm;
...
void slv6_G_MVN_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g34.S;
  const uint8_t d = instr->args.g34.d;
  const uint8_t m = instr->args.g34.m;
  const uint8_t s = instr->args.g34.s;
...
void slv6_G_MVN_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g33.S;
  const uint8_t d = instr->args.g33.d;
  const uint8_t m = instr->args.g33.m;
  const SLv6_Condition cond = instr->args.g33.cond;
...
void slv6_G_ORR_M1_LSLReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_ORR_M1_LSRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_ORR_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_ORR_M1_RRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_ORR_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_ORR_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g20.S;
  const uint8_t d = instr->args.g20.d;
  const uint8_t m = instr->args.g20.m;
  const uint8_t n = instr->args.g20.n;
...
/* A4.1.43
 * PKHBT */
void slv6_G_PKHBT(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
/* A4.1.44
 * PKHTB */
void slv6_G_PKHTB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g13.d;
  const uint8_t m = instr->args.g13.m;
  const uint8_t n = instr->args.g13.n;
  const uint8_t shift_imm = instr->args.g13.shift_imm;
...
void slv6_G_PLD_M2_ImmOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t n = instr->args.g39.n;
  const uint32_t signed_offset_12 = instr->args.g39.signed_offset_12;
  const uint32_t old_Rn = reg(proc,n);
  uint32_t address;
  address = (old_Rn + signed_offset_12);
...
void slv6_G_PLD_M2_RegOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g40.U;
  const uint8_t m = instr->args.g40.m;
  const uint8_t n = instr->args.g40.n;
  const uint32_t old_Rn = reg(proc,n);
  const uint32_t old_Rm = reg(proc,m);
  uint32_t address;
  address = ((U == 1)? (old_Rn + old_Rm): (old_Rn - old_Rm));
...
void slv6_G_PLD_M2_ScRegOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g41.U;
  const uint8_t m = instr->args.g41.m;
  const uint8_t n = instr->args.g41.n;
  const uint8_t shift = instr->args.g41.shift;
  const uint8_t shift_imm = instr->args.g41.shift_imm;
  const uint32_t old_Rn = reg(proc,n);
  const uint32_t old_Rm = reg(proc,m);
  uint32_t address;
  uint32_t index;
...
/* A4.1.46
 * QADD */
void slv6_G_QADD(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
/* A4.1.47
 * QADD16 */
void slv6_G_QADD16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.48
 * QADD8 */
void slv6_G_QADD8(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.49
 * QADDSUBX */
void slv6_G_QADDSUBX(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.50
 * QDADD */
void slv6_G_QDADD(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.51
 * QDSUB */
void slv6_G_QDSUB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.52
 * QSUB */
void slv6_G_QSUB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.53
 * QSUB16 */
void slv6_G_QSUB16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.54
 * QSUB8 */
void slv6_G_QSUB8(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.55
 * QSUBADDX */
void slv6_G_QSUBADDX(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.56
 * REV */
void slv6_G_REV(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g7.d;
  const uint8_t m = instr->args.g7.m;
  const SLv6_Condition cond = instr->args.g7.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
...
/* A4.1.57
 * REV16 */
void slv6_G_REV16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g7.d;
  const uint8_t m = instr->args.g7.m;
  const SLv6_Condition cond = instr->args.g7.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
...
/* A4.1.58
 * REVSH */
void slv6_G_REVSH(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g7.d;
  const uint8_t m = instr->args.g7.m;
  const SLv6_Condition cond = instr->args.g7.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
...
void slv6_G_RFE_M4_IA(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool W = instr->args.g42.W;
  const uint8_t n = instr->args.g42.n;
  const uint32_t old_Rn = reg(proc,n);
  uint32_t address;
  uint32_t end_address;
  uint32_t new_Rn;
...
void slv6_G_RFE_M4_IB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool W = instr->args.g42.W;
  const uint8_t n = instr->args.g42.n;
  const uint32_t old_Rn = reg(proc,n);
  uint32_t address;
...
void slv6_G_RFE_M4_DA(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool W = instr->args.g42.W;
  const uint8_t n = instr->args.g42.n;
  const uint32_t old_Rn = reg(proc,n);
  uint32_t address;
...
void slv6_G_RFE_M4_DB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool W = instr->args.g42.W;
  const uint8_t n = instr->args.g42.n;
  const uint32_t old_Rn = reg(proc,n);
  uint32_t address;
...
void slv6_G_RSB_M1_LSLReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_RSB_M1_LSRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_RSB_M1_LSRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_RSB_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_RSB_M1_RRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_RSB_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_RSB_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g20.S;
  const uint8_t d = instr->args.g20.d;
  const uint8_t m = instr->args.g20.m;
  const uint8_t n = instr->args.g20.n;
...
void slv6_G_RSC_M1_Imm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g17.S;
  const uint8_t d = instr->args.g17.d;
  const uint8_t n = instr->args.g17.n;
  const uint8_t rotate_imm = instr->args.g17.rotate_imm;
...
void slv6_G_RSC_M1_Reg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g20.S;
  const uint8_t d = instr->args.g20.d;
  const uint8_t m = instr->args.g20.m;
  const uint8_t n = instr->args.g20.n;
...
void slv6_G_RSC_M1_LSLImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_RSC_M1_LSLReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_RSC_M1_LSRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_RSC_M1_LSRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_RSC_M1_ASRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_RSC_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_RSC_M1_RRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_RSC_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_RSC_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g20.S;
  const uint8_t d = instr->args.g20.d;
  const uint8_t m = instr->args.g20.m;
  const uint8_t n = instr->args.g20.n;
...
/* A4.1.62
 * SADD16 */
void slv6_G_SADD16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.63
 * SADD8 */
void slv6_G_SADD8(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.64
 * SADDSUBX */
void slv6_G_SADDSUBX(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
void slv6_G_SBC_M1_Imm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g17.S;
  const uint8_t d = instr->args.g17.d;
  const uint8_t n = instr->args.g17.n;
  const uint8_t rotate_imm = instr->args.g17.rotate_imm;
...
void slv6_G_SBC_M1_Reg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g20.S;
  const uint8_t d = instr->args.g20.d;
  const uint8_t m = instr->args.g20.m;
  const uint8_t n = instr->args.g20.n;
...
void slv6_G_SBC_M1_LSLImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_SBC_M1_LSLReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_SBC_M1_LSRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_SBC_M1_LSRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_SBC_M1_ASRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_SBC_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_SBC_M1_RRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_SBC_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_SBC_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g20.S;
  const uint8_t d = instr->args.g20.d;
  const uint8_t m = instr->args.g20.m;
  const uint8_t n = instr->args.g20.n;
...
/* A4.1.66
 * SEL */
void slv6_G_SEL(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.67
 * SETEND */
void slv6_G_SETEND(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool E = instr->args.g43.E;
  proc->cpsr.E_flag = E;
}

/* A4.1.68
 * SHADD16 */
void slv6_G_SHADD16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.69
 * SHADD8 */
void slv6_G_SHADD8(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.70
 * SHADDSUBX */
void slv6_G_SHADDSUBX(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.71
 * SHSUB16 */
void slv6_G_SHSUB16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.72
 * SHSUB8 */
void slv6_G_SHSUB8(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.73
 * SHSUBADDX */
void slv6_G_SHSUBADDX(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.74
 * SMLA<x><y> */
void slv6_G_SMLAxy(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g44.d;
  const uint8_t m = instr->args.g44.m;
  const uint8_t n = instr->args.g44.n;
  const uint8_t s = instr->args.g44.s;
  const bool x = instr->args.g44.x;
  const bool y = instr->args.g44.y;
  const SLv6_Condition cond = instr->args.g44.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rs = reg(proc,s);
  const uint32_t old_Rn = reg(proc,n);
  const uint32_t old_Rm = reg(proc,m);
...
/* A4.1.75
 * SMLAD */
void slv6_G_SMLAD(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool X = instr->args.g45.X;
  const uint8_t d = instr->args.g45.d;
  const uint8_t m = instr->args.g45.m;
  const uint8_t n = instr->args.g45.n;
  const uint8_t s = instr->args.g45.s;
  const SLv6_Condition cond = instr->args.g45.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rs = reg(proc,s);
  const uint32_t old_Rn = reg(proc,n);
  const uint32_t old_Rm = reg(proc,m);
...
/* A4.1.76
 * SMLAL */
void slv6_G_SMLAL(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g46.S;
  const uint8_t dHi = instr->args.g46.dHi;
  const uint8_t dLo = instr->args.g46.dLo;
  const uint8_t m = instr->args.g46.m;
  const uint8_t s = instr->args.g46.s;
  const SLv6_Condition cond = instr->args.g46.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rs = reg(proc,s);
  const uint32_t old_Rm = reg(proc,m);
...
/* A4.1.77
 * SMLAL<x><y> */
void slv6_G_SMLALxy(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t dHi = instr->args.g47.dHi;
  const uint8_t dLo = instr->args.g47.dLo;
  const uint8_t m = instr->args.g47.m;
  const uint8_t s = instr->args.g47.s;
  const bool x = instr->args.g47.x;
  const bool y = instr->args.g47.y;
  const SLv6_Condition cond = instr->args.g47.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rs = reg(proc,s);
  const uint32_t old_Rm = reg(proc,m);
  const uint32_t old_RdLo = reg(proc,dLo);
...
/* A4.1.78
 * SMLALD */
void slv6_G_SMLALD(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool X = instr->args.g48.X;
  const uint8_t dHi = instr->args.g48.dHi;
  const uint8_t dLo = instr->args.g48.dLo;
  const uint8_t m = instr->args.g48.m;
  const uint8_t s = instr->args.g48.s;
  const SLv6_Condition cond = instr->args.g48.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rs = reg(proc,s);
  const uint32_t old_Rm = reg(proc,m);
  const uint32_t old_RdLo = reg(proc,dLo);
...
/* A4.1.79
 * SMLAW<y> */
void slv6_G_SMLAWy(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g49.d;
  const uint8_t m = instr->args.g49.m;
  const uint8_t n = instr->args.g49.n;
  const uint8_t s = instr->args.g49.s;
  const bool y = instr->args.g49.y;
  const SLv6_Condition cond = instr->args.g49.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rs = reg(proc,s);
  const uint32_t old_Rn = reg(proc,n);
  const uint32_t old_Rm = reg(proc,m);
...
/* A4.1.80
 * SMLSD */
void slv6_G_SMLSD(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool X = instr->args.g45.X;
  const uint8_t d = instr->args.g45.d;
  const uint8_t m = instr->args.g45.m;
  const uint8_t n = instr->args.g45.n;
...
/* A4.1.81
 * SMLSLD */
void slv6_G_SMLSLD(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool X = instr->args.g48.X;
  const uint8_t dHi = instr->args.g48.dHi;
  const uint8_t dLo = instr->args.g48.dLo;
  const uint8_t m = instr->args.g48.m;
...
/* A4.1.82
 * SMMLA */
void slv6_G_SMMLA(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool R = instr->args.g50.R;
  const uint8_t d = instr->args.g50.d;
  const uint8_t m = instr->args.g50.m;
  const uint8_t n = instr->args.g50.n;
  const uint8_t s = instr->args.g50.s;
  const SLv6_Condition cond = instr->args.g50.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rs = reg(proc,s);
  const uint32_t old_Rn = reg(proc,n);
  const uint32_t old_Rm = reg(proc,m);
...
/* A4.1.83
 * SMMLS */
void slv6_G_SMMLS(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool R = instr->args.g50.R;
  const uint8_t d = instr->args.g50.d;
  const uint8_t m = instr->args.g50.m;
  const uint8_t n = instr->args.g50.n;
...
/* A4.1.84
 * SMMUL */
void slv6_G_SMMUL(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool R = instr->args.g51.R;
  const uint8_t d = instr->args.g51.d;
  const uint8_t m = instr->args.g51.m;
  const uint8_t s = instr->args.g51.s;
  const SLv6_Condition cond = instr->args.g51.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rs = reg(proc,s);
  const uint32_t old_Rm = reg(proc,m);
  uint32_t value;
...
/* A4.1.85
 * SMUAD */
void slv6_G_SMUAD(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool X = instr->args.g52.X;
  const uint8_t d = instr->args.g52.d;
  const uint8_t m = instr->args.g52.m;
  const uint8_t s = instr->args.g52.s;
  const SLv6_Condition cond = instr->args.g52.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rs = reg(proc,s);
  const uint32_t old_Rm = reg(proc,m);
  uint32_t operand2;
...
/* A4.1.86
 * SMUL<x><y> */
void slv6_G_SMULxy(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g53.d;
  const uint8_t m = instr->args.g53.m;
  const uint8_t s = instr->args.g53.s;
  const bool x = instr->args.g53.x;
  const bool y = instr->args.g53.y;
  const SLv6_Condition cond = instr->args.g53.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rs = reg(proc,s);
  const uint32_t old_Rm = reg(proc,m);
  uint32_t operand1;
...
/* A4.1.88
 * SMULW<y> */
void slv6_G_SMULWy(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g54.d;
  const uint8_t m = instr->args.g54.m;
  const uint8_t s = instr->args.g54.s;
  const bool y = instr->args.g54.y;
  const SLv6_Condition cond = instr->args.g54.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rs = reg(proc,s);
  const uint32_t old_Rm = reg(proc,m);
  uint32_t operand2;
...
/* A4.1.89
 * SMUSD */
void slv6_G_SMUSD(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool X = instr->args.g52.X;
  const uint8_t d = instr->args.g52.d;
  const uint8_t m = instr->args.g52.m;
  const uint8_t s = instr->args.g52.s;
...
void slv6_G_SRS_M4_IA(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool W = instr->args.g55.W;
  const SLv6_Mode mode = instr->args.g55.mode;
  uint32_t address;
  uint32_t end_address;
  uint32_t new_Rn;
  SLv6_Mode old_mode;
...
void slv6_G_SRS_M4_IB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool W = instr->args.g55.W;
  const SLv6_Mode mode = instr->args.g55.mode;
  uint32_t address;
  uint32_t end_address;
...
void slv6_G_SRS_M4_DA(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool W = instr->args.g55.W;
  const SLv6_Mode mode = instr->args.g55.mode;
  uint32_t address;
  uint32_t end_address;
...
void slv6_G_SRS_M4_DB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool W = instr->args.g55.W;
  const SLv6_Mode mode = instr->args.g55.mode;
  uint32_t address;
  uint32_t end_address;
...
/* A4.1.91
 * SSAT */
void slv6_G_SSAT(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g56.d;
  const uint8_t m = instr->args.g56.m;
  const uint8_t sat_imm = instr->args.g56.sat_imm;
  const uint8_t shift = instr->args.g56.shift;
  const uint8_t shift_imm = instr->args.g56.shift_imm;
  const SLv6_Condition cond = instr->args.g56.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rm = reg(proc,m);
  uint32_t operand;
...
/* A4.1.92
 * SSAT16 */
void slv6_G_SSAT16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g57.d;
  const uint8_t m = instr->args.g57.m;
  const uint8_t sat_imm = instr->args.g57.sat_imm;
  const SLv6_Condition cond = instr->args.g57.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rm = reg(proc,m);
...
/* A4.1.93
 * SSUB16 */
void slv6_G_SSUB16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.94
 * SSUB8 */
void slv6_G_SSUB8(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.95
 * SSUBADDX */
void slv6_G_SSUBADDX(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
void slv6_G_STC_M5_ImmOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  exec_undefined_instruction(proc, NULL);
}

/* A4.1.96--A5.5.3
 * STC -- Load and Store Coprocessor - Immediate pre indexed */
void slv6_G_STC_M5_Imm_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  exec_undefined_instruction(proc, NULL);
}

/* A4.1.96--A5.5.4
 * STC -- Load and Store Coprocessor - Immediate post indexed */
void slv6_G_STC_M5_Imm_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  exec_undefined_instruction(proc, NULL);
}

/* A4.1.96--A5.5.5
 * STC -- Load and Store Coprocessor - Unindexed */
void slv6_G_STC_M5_U(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  exec_undefined_instruction(proc, NULL);
}

/* A4.1.97--A5.4.4
 * STM (1) -- Load and Store Multiple - Decrement after */
void slv6_G_STM1_M4_DA(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool W = instr->args.g26.W;
  const uint8_t n = instr->args.g26.n;
  const uint8_t nb_reg_x4 = instr->args.g26.nb_reg_x4;
  const SLv6_Condition cond = instr->args.g26.cond;
...
void slv6_G_STM2_M4_IA(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t n = instr->args.g9.n;
  const uint8_t nb_reg_x4 = instr->args.g9.nb_reg_x4;
  const SLv6_Condition cond = instr->args.g9.cond;
  const uint32_t register_list = instr->args.g9.register_list;
...
void slv6_G_STM2_M4_IB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t n = instr->args.g9.n;
  const uint8_t nb_reg_x4 = instr->args.g9.nb_reg_x4;
  const SLv6_Condition cond = instr->args.g9.cond;
  const uint32_t register_list = instr->args.g9.register_list;
...
void slv6_G_STM2_M4_DA(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t n = instr->args.g9.n;
  const uint8_t nb_reg_x4 = instr->args.g9.nb_reg_x4;
  const SLv6_Condition cond = instr->args.g9.cond;
  const uint32_t register_list = instr->args.g9.register_list;
...
void slv6_G_STM2_M4_DB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t n = instr->args.g9.n;
  const uint8_t nb_reg_x4 = instr->args.g9.nb_reg_x4;
  const SLv6_Condition cond = instr->args.g9.cond;
  const uint32_t register_list = instr->args.g9.register_list;
...
void slv6_G_STR_M2_Reg_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_STR_M2_ScReg_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g28.U;
  const uint8_t d = instr->args.g28.d;
  const uint8_t m = instr->args.g28.m;
  const uint8_t n = instr->args.g28.n;
...
void slv6_G_STR_M2_ScReg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g28.U;
  const uint8_t d = instr->args.g28.d;
  const uint8_t m = instr->args.g28.m;
  const uint8_t n = instr->args.g28.n;
...
void slv6_G_STRB_M2_ScRegOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g28.U;
  const uint8_t d = instr->args.g28.d;
  const uint8_t m = instr->args.g28.m;
  const uint8_t n = instr->args.g28.n;
...
void slv6_G_STRB_M2_Imm_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g1.d;
  const uint8_t n = instr->args.g1.n;
  const SLv6_Condition cond = instr->args.g1.cond;
  const uint32_t signed_offset_12 = instr->args.g1.signed_offset_12;
...
void slv6_G_STRB_M2_Reg_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_STRB_M2_ScReg_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g28.U;
  const uint8_t d = instr->args.g28.d;
  const uint8_t m = instr->args.g28.m;
  const uint8_t n = instr->args.g28.n;
...
void slv6_G_STRB_M2_Reg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_STRB_M2_ScReg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g28.U;
  const uint8_t d = instr->args.g28.d;
  const uint8_t m = instr->args.g28.m;
  const uint8_t n = instr->args.g28.n;
...
void slv6_G_STRBT_M2_Imm_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g1.d;
  const uint8_t n = instr->args.g1.n;
  const SLv6_Condition cond = instr->args.g1.cond;
  const uint32_t signed_offset_12 = instr->args.g1.signed_offset_12;
...
void slv6_G_STRBT_M2_Reg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_STRBT_M2_ScReg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g28.U;
  const uint8_t d = instr->args.g28.d;
  const uint8_t m = instr->args.g28.m;
  const uint8_t n = instr->args.g28.n;
...
void slv6_G_STRD_M3_ImmOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_STRD_M3_RegOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_STRD_M3_Imm_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_STRD_M3_Reg_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_STRD_M3_Imm_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_STRD_M3_Reg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
/* A4.1.103
 * STREX */
void slv6_G_STREX(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
void slv6_G_STRH_M3_ImmOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_STRH_M3_RegOff(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_STRH_M3_Imm_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_STRH_M3_Reg_preInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_STRH_M3_Imm_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g29.U;
  const uint8_t d = instr->args.g29.d;
  const uint8_t n = instr->args.g29.n;
  const uint8_t immedHL = instr->args.g29.immedHL;
...
void slv6_G_STRH_M3_Reg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_STRT_M2_Imm_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g1.d;
  const uint8_t n = instr->args.g1.n;
  const SLv6_Condition cond = instr->args.g1.cond;
  const uint32_t signed_offset_12 = instr->args.g1.signed_offset_12;
...
void slv6_G_STRT_M2_Reg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g27.U;
  const uint8_t d = instr->args.g27.d;
  const uint8_t m = instr->args.g27.m;
  const uint8_t n = instr->args.g27.n;
...
void slv6_G_STRT_M2_ScReg_postInd(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool U = instr->args.g28.U;
  const uint8_t d = instr->args.g28.d;
  const uint8_t m = instr->args.g28.m;
  const uint8_t n = instr->args.g28.n;
...
void slv6_G_SUB_M1_Reg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g20.S;
  const uint8_t d = instr->args.g20.d;
  const uint8_t m = instr->args.g20.m;
  const uint8_t n = instr->args.g20.n;
...
void slv6_G_SUB_M1_LSLReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_SUB_M1_LSRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_SUB_M1_LSRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_SUB_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_SUB_M1_RRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g18.S;
  const uint8_t d = instr->args.g18.d;
  const uint8_t m = instr->args.g18.m;
  const uint8_t n = instr->args.g18.n;
...
void slv6_G_SUB_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g19.S;
  const uint8_t d = instr->args.g19.d;
  const uint8_t m = instr->args.g19.m;
  const uint8_t n = instr->args.g19.n;
...
void slv6_G_SUB_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g20.S;
  const uint8_t d = instr->args.g20.d;
  const uint8_t m = instr->args.g20.m;
  const uint8_t n = instr->args.g20.n;
...
/* A4.1.107
 * SWI */
void slv6_G_SWI(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const SLv6_Condition cond = instr->args.g58.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  uint32_t addr_of_next_instr;
  addr_of_next_instr = (reg(proc,15) - 4);
...
/* A4.1.108
 * SWP */
void slv6_G_SWP(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.109
 * SWPB */
void slv6_G_SWPB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.110
 * SXTAB */
void slv6_G_SXTAB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g59.d;
  const uint8_t m = instr->args.g59.m;
  const uint8_t n = instr->args.g59.n;
  const uint8_t rotate = instr->args.g59.rotate;
  const SLv6_Condition cond = instr->args.g59.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rn = reg(proc,n);
  const uint32_t old_Rm = reg(proc,m);
  uint32_t operand2;
...
/* A4.1.111
 * SXTAB16 */
void slv6_G_SXTAB16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g59.d;
  const uint8_t m = instr->args.g59.m;
  const uint8_t n = instr->args.g59.n;
  const uint8_t rotate = instr->args.g59.rotate;
...
/* A4.1.112
 * SXTAH */
void slv6_G_SXTAH(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g59.d;
  const uint8_t m = instr->args.g59.m;
  const uint8_t n = instr->args.g59.n;
  const uint8_t rotate = instr->args.g59.rotate;
...
/* A4.1.113
 * SXTB */
void slv6_G_SXTB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g60.d;
  const uint8_t m = instr->args.g60.m;
  const uint8_t rotate = instr->args.g60.rotate;
  const SLv6_Condition cond = instr->args.g60.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rm = reg(proc,m);
  uint32_t operand2;
  operand2 = rotate_right(old_Rm, (rotate * 8));
...
/* A4.1.114
 * SXTB16 */
void slv6_G_SXTB16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g60.d;
  const uint8_t m = instr->args.g60.m;
  const uint8_t rotate = instr->args.g60.rotate;
  const SLv6_Condition cond = instr->args.g60.cond;
...
/* A4.1.115
 * SXTH */
void slv6_G_SXTH(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g60.d;
  const uint8_t m = instr->args.g60.m;
  const uint8_t rotate = instr->args.g60.rotate;
  const SLv6_Condition cond = instr->args.g60.cond;
...
void slv6_G_TEQ_M1_Imm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
void slv6_G_TEQ_M1_Reg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g4.m;
  const uint8_t n = instr->args.g4.n;
  const SLv6_Condition cond = instr->args.g4.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
...
void slv6_G_TEQ_M1_LSLImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
...
void slv6_G_TEQ_M1_LSLReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
...
void slv6_G_TEQ_M1_LSRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
...
void slv6_G_TEQ_M1_LSRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
...
void slv6_G_TEQ_M1_ASRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
...
void slv6_G_TEQ_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
...
void slv6_G_TEQ_M1_RRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
...
void slv6_G_TEQ_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
...
void slv6_G_TEQ_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g4.m;
  const uint8_t n = instr->args.g4.n;
  const SLv6_Condition cond = instr->args.g4.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
...
void slv6_G_TST_M1_LSLImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
...
void slv6_G_TST_M1_LSLReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
...
void slv6_G_TST_M1_LSRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
...
void slv6_G_TST_M1_LSRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
...
void slv6_G_TST_M1_ASRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
...
void slv6_G_TST_M1_ASRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
...
void slv6_G_TST_M1_RRImm(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g23.m;
  const uint8_t n = instr->args.g23.n;
  const uint8_t shift_imm = instr->args.g23.shift_imm;
  const SLv6_Condition cond = instr->args.g23.cond;
...
void slv6_G_TST_M1_RRReg(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g24.m;
  const uint8_t n = instr->args.g24.n;
  const uint8_t s = instr->args.g24.s;
  const SLv6_Condition cond = instr->args.g24.cond;
...
void slv6_G_TST_M1_RRE(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t m = instr->args.g4.m;
  const uint8_t n = instr->args.g4.n;
  const SLv6_Condition cond = instr->args.g4.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
...
/* A4.1.118
 * UADD16 */
void slv6_G_UADD16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.119
 * UADD8 */
void slv6_G_UADD8(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.120
 * UADDSUBX */
void slv6_G_UADDSUBX(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.121
 * UHADD16 */
void slv6_G_UHADD16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.122
 * UHADD8 */
void slv6_G_UHADD8(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.123
 * UHADDSUBX */
void slv6_G_UHADDSUBX(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.124
 * UHSUB16 */
void slv6_G_UHSUB16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.125
 * UHSUB8 */
void slv6_G_UHSUB8(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.126
 * UHSUBADDX */
void slv6_G_UHSUBADDX(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.127
 * UMAAL */
void slv6_G_UMAAL(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
/* A4.1.128
 * UMLAL */
void slv6_G_UMLAL(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g46.S;
  const uint8_t dHi = instr->args.g46.dHi;
  const uint8_t dLo = instr->args.g46.dLo;
  const uint8_t m = instr->args.g46.m;
...
/* A4.1.129
 * UMULL */
void slv6_G_UMULL(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool S = instr->args.g46.S;
  const uint8_t dHi = instr->args.g46.dHi;
  const uint8_t dLo = instr->args.g46.dLo;
  const uint8_t m = instr->args.g46.m;
...
/* A4.1.130
 * UQADD16 */
void slv6_G_UQADD16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.131
 * UQADD8 */
void slv6_G_UQADD8(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.132
 * UQADDSUBX */
void slv6_G_UQADDSUBX(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.133
 * UQSUB16 */
void slv6_G_UQSUB16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.134
 * UQSUB8 */
void slv6_G_UQSUB8(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.135
 * UQSUBADDX */
void slv6_G_UQSUBADDX(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.136
 * USAD8 */
void slv6_G_USAD8(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
/* A4.1.137
 * USADA8 */
void slv6_G_USADA8(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g61.d;
  const uint8_t m = instr->args.g61.m;
  const uint8_t n = instr->args.g61.n;
  const uint8_t s = instr->args.g61.s;
  const SLv6_Condition cond = instr->args.g61.cond;
  if (!ConditionPassed(&proc->cpsr, cond)) return;
  const uint32_t old_Rs = reg(proc,s);
  const uint32_t old_Rn = reg(proc,n);
  const uint32_t old_Rm = reg(proc,m);
...
/* A4.1.138
 * USAT */
void slv6_G_USAT(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g56.d;
  const uint8_t m = instr->args.g56.m;
  const uint8_t sat_imm = instr->args.g56.sat_imm;
  const uint8_t shift = instr->args.g56.shift;
...
/* A4.1.139
 * USAT16 */
void slv6_G_USAT16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g57.d;
  const uint8_t m = instr->args.g57.m;
  const uint8_t sat_imm = instr->args.g57.sat_imm;
  const SLv6_Condition cond = instr->args.g57.cond;
...
/* A4.1.140
 * USUB16 */
void slv6_G_USUB16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.141
 * USUB8 */
void slv6_G_USUB8(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.142
 * USUBADDX */
void slv6_G_USUBADDX(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g5.d;
  const uint8_t m = instr->args.g5.m;
  const uint8_t n = instr->args.g5.n;
  const SLv6_Condition cond = instr->args.g5.cond;
...
/* A4.1.143
 * UXTAB */
void slv6_G_UXTAB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g59.d;
  const uint8_t m = instr->args.g59.m;
  const uint8_t n = instr->args.g59.n;
  const uint8_t rotate = instr->args.g59.rotate;
...
/* A4.1.144
 * UXTAB16 */
void slv6_G_UXTAB16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g59.d;
  const uint8_t m = instr->args.g59.m;
  const uint8_t n = instr->args.g59.n;
  const uint8_t rotate = instr->args.g59.rotate;
...
/* A4.1.145
 * UXTAH */
void slv6_G_UXTAH(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g59.d;
  const uint8_t m = instr->args.g59.m;
  const uint8_t n = instr->args.g59.n;
  const uint8_t rotate = instr->args.g59.rotate;
...
/* A4.1.146
 * UXTB */
void slv6_G_UXTB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g60.d;
  const uint8_t m = instr->args.g60.m;
  const uint8_t rotate = instr->args.g60.rotate;
  const SLv6_Condition cond = instr->args.g60.cond;
...
/* A4.1.147
 * UXTB16 */
void slv6_G_UXTB16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g60.d;
  const uint8_t m = instr->args.g60.m;
  const uint8_t rotate = instr->args.g60.rotate;
  const SLv6_Condition cond = instr->args.g60.cond;
...
/* A4.1.148
 * UXTH */
void slv6_G_UXTH(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g60.d;
  const uint8_t m = instr->args.g60.m;
  const uint8_t rotate = instr->args.g60.rotate;
  const SLv6_Condition cond = instr->args.g60.cond;
...
/* A7.1.7
 * ADD (5) */
void slv6_G_Tb_ADD5(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
/* A7.1.12
 * ASR (2) */
void slv6_G_Tb_ASR2(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
/* A7.1.16
 * BKPT */
void slv6_G_Tb_BKPT(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  if (not_overridden_by_debug_hardware()) {
    set_reg_m(proc,14,abt,(address_of_current_instruction(proc) + 4));
    *spsr_m(proc,abt) = proc->cpsr;
    set_cpsr_mode(proc, abt);
...
/* A7.1.18
 * BLX (2) */
void slv6_G_Tb_BLX2(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
/* A7.1.20
 * CMN */
void slv6_G_Tb_CMN(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
/* A7.1.24
 * CPS */
void slv6_G_Tb_CPS(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool A = instr->args.g79.A;
  const bool F = instr->args.g79.F;
  const bool I = instr->args.g79.I;
  const uint8_t imod = instr->args.g79.imod;
  if (InAPrivilegedMode(proc)) {
    if ((A == 1))
...
/* A7.1.35
 * LDRH (2) */
void slv6_G_Tb_LDRH2(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
/* A7.1.36
 * LDRSB */
void slv6_G_Tb_LDRSB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g66.d;
  const uint8_t m = instr->args.g66.m;
  const uint8_t n = instr->args.g66.n;
  const uint32_t old_Rn = reg(proc,n);
...
/* A7.1.37
 * LDRSH */
void slv6_G_Tb_LDRSH(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g66.d;
  const uint8_t m = instr->args.g66.m;
  const uint8_t n = instr->args.g66.n;
  const uint32_t old_Rn = reg(proc,n);
...
/* A7.1.51
 * REV */
void slv6_G_Tb_REV(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
/* A7.1.52
 * REV16 */
void slv6_G_Tb_REV16(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g69.d;
  const uint8_t n = instr->args.g69.n;
  const uint32_t old_Rn = reg(proc,n);
...
/* A7.1.53
 * REVSH */
void slv6_G_Tb_REVSH(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g69.d;
  const uint8_t n = instr->args.g69.n;
  const uint32_t old_Rn = reg(proc,n);
  set_field(addr_of_reg(proc,d), 15, 8, get_byte_0(old_Rn));
...
/* A7.1.55
 * SBC */
void slv6_G_Tb_SBC(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
/* A7.1.56
 * SETEND */
void slv6_G_Tb_SETEND(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const bool E = instr->args.g43.E;
  proc->cpsr.E_flag = E;
}
...
/* A7.1.63
 * STRH (1) */
void slv6_G_Tb_STRH1(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
...
/* A7.1.64
 * STRH (2) */
void slv6_G_Tb_STRH2(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g66.d;
  const uint8_t m = instr->args.g66.m;
  const uint8_t n = instr->args.g66.n;
  const uint32_t old_Rn = reg(proc,n);
...
/* A7.1.69
 * SWI */
void slv6_G_Tb_SWI(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  uint32_t addr_of_next_instr;
  addr_of_next_instr = (reg(proc,15) - 2);
  set_reg_m(proc,14,svc,addr_of_next_instr);
  *spsr_m(proc,svc) = proc->cpsr;
...
/* A7.1.70
 * SXTB */
void slv6_G_Tb_SXTB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g63.d;
  const uint8_t m = instr->args.g63.m;
  const uint32_t old_Rm = reg(proc,m);
...
/* A7.1.71
 * SXTH */
void slv6_G_Tb_SXTH(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g63.d;
  const uint8_t m = instr->args.g63.m;
  const uint32_t old_Rm = reg(proc,m);
...
/* A7.1.73
 * UXTB */
void slv6_G_Tb_UXTB(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g63.d;
  const uint8_t m = instr->args.g63.m;
  const uint32_t old_Rm = reg(proc,m);
...
/* A7.1.74
 * UXTH */
void slv6_G_Tb_UXTH(struct SLv6_Processor *proc, struct SLv6_Instruction *instr) {
  const uint8_t d = instr->args.g63.d;
  const uint8_t m = instr->args.g63.m;
  const uint32_t old_Rm = reg(proc,m);
